...
class UV extends UVHandler
{
  ...
  const UV_E2BIG = 'argument list too long';
  const UV_EACCES = 'permission denied';
  const UV_EADDRINUSE = 'address already in use';
  const UV_EADDRNOTAVAIL = 'address not available';
  const UV_EAFNOSUPPORT = 'address family not supported';
  const UV_EAGAIN = 'resource temporarily unavailable';
  const UV_EAI_ADDRFAMILY = 'address family not supported';
  const UV_EAI_AGAIN = 'temporary failure';
  const UV_EAI_BADFLAGS = 'bad ai_flags value';
  const UV_EAI_BADHINTS = 'invalid value for hints';
  const UV_EAI_CANCELED = 'request canceled';
  const UV_EAI_FAIL = 'permanent failure';
  const UV_EAI_FAMILY = 'ai_family not supported';
  const UV_EAI_MEMORY = 'out of memory';
  const UV_EAI_NODATA = 'no address';
  const UV_EAI_NONAME = 'unknown node or service';
  const UV_EAI_OVERFLOW = 'argument buffer overflow';
  const UV_EAI_PROTOCOL = 'resolved protocol is unknown';
  const UV_EAI_SERVICE = 'service not available for socket type';
  const UV_EAI_SOCKTYPE = 'socket type not supported';
  const UV_EALREADY = 'connection already in progress';
  const UV_EBADF = 'bad file descriptor';
  const UV_EBUSY = 'resource busy or locked';
  const UV_ECANCELED = 'operation canceled';
  const UV_ECHARSET = 'invalid Unicode character';
  const UV_ECONNABORTED = 'software caused connection abort';
  const UV_ECONNREFUSED = 'connection refused';
  const UV_ECONNRESET = 'connection reset by peer';
  const UV_EDESTADDRREQ = 'destination address required';
  const UV_EEXIST = 'file already exists';
  const UV_EFAULT = 'bad address in system call argument';
  const UV_EFBIG = 'file too large';
  const UV_EHOSTUNREACH = 'host is unreachable';
  const UV_EINTR = 'interrupted system call';
  const UV_EINVAL = 'invalid argument';
  const UV_EIO = 'i/o error';
  const UV_EISCONN = 'socket is already connected';
  const UV_EISDIR = 'illegal operation on a directory';
  const UV_ELOOP = 'too many symbolic links encountered';
  const UV_EMFILE = 'too many open files';
  const UV_EMSGSIZE = 'message too long';
  const UV_ENAMETOOLONG = 'name too long';
  const UV_ENETDOWN = 'network is down';
  const UV_ENETUNREACH = 'network is unreachable';
  const UV_ENFILE = 'file table overflow';
  const UV_ENOBUFS = 'no buffer space available';
  const UV_ENODEV = 'no such device';
  const UV_ENOENT = 'no such file or directory';
  const UV_ENOMEM = 'not enough memory';
  const UV_ENONET = 'machine is not on the network';
  const UV_ENOPROTOOPT = 'protocol not available';
  const UV_ENOSPC = 'no space left on device';
  const UV_ENOSYS = 'function not implemented';
  const UV_ENOTCONN = 'socket is not connected';
  const UV_ENOTDIR = 'not a directory';
  const UV_ENOTEMPTY = 'directory not empty';
  const UV_ENOTSOCK = 'socket operation on non-socket';
  const UV_ENOTSUP = 'operation not supported on socket';
  const UV_EPERM = 'operation not permitted';
  const UV_EPIPE = 'broken pipe';
  const UV_EPROTO = 'protocol error';
  const UV_EPROTONOSUPPORT = 'protocol not supported';
  const UV_EPROTOTYPE = 'protocol wrong type for socket';
  const UV_ERANGE = 'result too large';
  const UV_EROFS = 'read-only file system';
  const UV_ESHUTDOWN = 'cannot send after transport endpoint shutdown';
  const UV_ESPIPE = 'invalid seek';
  const UV_ESRCH = 'no such process';
  const UV_ETIMEDOUT = 'connection timed out';
  const UV_ETXTBSY = 'text file is busy';
  const UV_EXDEV = 'cross-device link not permitted';
  const UV_UNKNOWN = 'unknown error';
  const UV_EOF = 'end of file';
  const UV_ENXIO = 'no such device or address';
  const UV_EMLINK = 'too many links';
  const UV_ENOTTY = 'inappropriate ioctl for device';
  const UV_EFTYPE = 'inappropriate file type or format';
  const UV_EILSEQ = 'illegal byte sequence';
}
